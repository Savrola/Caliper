...
// Test this class by instantiating Date_selector
...
/** A Popup_dialog is a clean, lightweight, "modal" window intended for
 *  simple pop-up user-interface widgets. The  frame, as shown at right,
 *  <img src="../../../images/Popup_dialog.gif" align=right>
...
//    private Color CLOSE_BOX_COLOR = com.holub.ui.Colors.DARK_RED;
    public static final Color TITLE_BAR_COLOR = Color.LIGHT_GRAY;
    public static final Color TEXT_COLOR = Color.getHSBColor( 0.6f, 1.0f, 0.5f * 0.8f ); // new Color( 0, 61, 153 );
    public static final Color CLOSE_BOX_COLOR = TEXT_COLOR;
    public static final Color HIGHLIGHT_BOX_COLOR = Color.getHSBColor( 0.6f, 1.0f * 0.5f, 0.5f * 1.6f );
        ...
        addWindowFocusListener(
                new WindowFocusListener() {
                    public void windowGainedFocus( WindowEvent windowEvent ) {
                        System.out.println( "gained focus:  " + windowEvent );
                    }

                    public void windowLostFocus( WindowEvent windowEvent ) {
                        System.out.println( "lost focus:  " + windowEvent );
                    }
                }
        );
        setUndecorated( true );
        JPanel contents = new JPanel();
//        contents.setBorder( BorderFactory.createLineBorder( Color.GREEN, 1 ) );
...
//        setFocusTraversalKeysEnabled( false );
        ...
        contents.getInputMap().put( KeyStroke.getKeyStroke( "ESCAPE" ), "escapeTyped" );
        contents.getActionMap().put( "escapeTyped", new AbstractAction() {
...
//        requestFocusInWindow();
    ...
    private JButton create_close_button() {
        URL image = getClass().getClassLoader().getResource(
                "com/holub/images/8px.red.X.gif"
        );

        JButton b = ( image != null ) ? new JButton( Navigable_date_selector.transmogrifyImage( new ImageIcon( image ) ) )
                : new JButton( "  X  " );
     ...
     *  itself. The returned container is a {@link javax.swing.JPanel JPanel}
     *  with a preinstalled {@link java.awt.BorderLayout}.
    ...
    private static class Test {
        public static void main( String[] args ) {
            ...
            final JDialog dialog = new Popup_dialog( main );
            ...
            Popup_dialog d = (Popup_dialog)dialog;
