...
public abstract class TableInfo implements Serializable {
     ...
     * @throws com.obtuse.db.raw.exceptions.ObtuseMoreThanOneFoundException if more than one instance was found.
     */

    public Tuple2 findOne( ElephantConnection elephantConnection, int columnIx, DBValue key )
            throws
            SQLException,
            ObtuseMoreThanOneFoundException {
        ...
        try {
            ...
            if ( rs.next() ) {
                ...
                if ( rs.next() ) {
                    ...
                    throw new ObtuseMoreThanOneFoundException(
